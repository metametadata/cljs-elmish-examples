 ...
 */
frontend.ui.connect_reagent = (function frontend$ui$connect_reagent(p__28417,init_args){
...
var _spec_ = map__28420__$1;
var init = cljs.core.get.call(null,map__28420__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var view_model = cljs.core.get.call(null,map__28420__$1,new cljs.core.Keyword(null,"view-model","view-model",-895405675));
var view = cljs.core.get.call(null,map__28420__$1,new cljs.core.Keyword(null,"view","view",1247994814));
var control = cljs.core.get.call(null,map__28420__$1,new cljs.core.Keyword(null,"control","control",1892578036));
var reconcile = cljs.core.get.call(null,map__28420__$1,new cljs.core.Keyword(null,"reconcile","reconcile",-728661830));
var model = cljs.core.apply.call(null,init,init_args);
var model_ratom = reagent.core.atom.call(null,model);
var dispatch_action = ((function (model,model_ratom,map__28420,map__28420__$1,_spec_,init,view_model,view,control,reconcile){
...
});})(model,model_ratom,map__28420,map__28420__$1,_spec_,init,view_model,view,control,reconcile))
;
var dispatch_signal = ((function (model,model_ratom,map__28420,map__28420__$1,_spec_,init,view_model,view,control,reconcile){
...
;
var reagent_view = ((function (model,model_ratom,map__28420,map__28420__$1,_spec_,init,view_model,view,control,reconcile){
...
return cljs.core.update.call(null,cljs.core.update.call(null,spec,new cljs.core.Keyword(null,"control","control",1892578036),(function (p1__28422_SHARP_){
return (function frontend$ui$wrap_log_$_control(model,signal,dispatch){
cljs.core.println.call(null,"signal =",signal);

return p1__28422_SHARP_.call(null,model,signal,dispatch);
});
})),new cljs.core.Keyword(null,"reconcile","reconcile",-728661830),(function (p1__28423_SHARP_){
return (function frontend$ui$wrap_log_$_reconcile(model,action){
cljs.core.println.call(null,"  action =",action);

var result = p1__28423_SHARP_.call(null,model,action);
...
//# sourceMappingURL=ui.js.map?rel=1450277834762